...
def loadKNNDataAndTrainKNN():
    ...
    npaClassifications = npaClassifications.reshape((npaClassifications.size, 1))       # reshape to one dimension
...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    if len(listOfPossiblePlates) == 0:          # if list of plates is empty
    ...
    for possiblePlate in listOfPossiblePlates:
        ...
        if Main.showSteps == True: # show steps ###################################################
            cv2.imshow("5a- Org Plate", possiblePlate.imgPlate)
            cv2.imshow("5b- Grayscale", possiblePlate.imgGrayscale)
            cv2.imshow("5c- Threshold", possiblePlate.imgThresh)
        # end if # show steps #####################################################################
        ...
        if (len(listOfListsOfMatchingCharsInPlate) == 0):			# if no groups of matching chars were found in the plate
            ...
            if Main.showSteps == True: # show steps ###############################################
                print("click on any image and press a key to continue . . .")
